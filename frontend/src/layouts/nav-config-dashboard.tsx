...
export const navData: NavSectionProps['data'] = [
   ...
   */
  {
    ...
    items: [
      { title: 'Receipts', path: paths.dashboard.receipt.root, icon: ICONS.invoice },
      { title: 'Analytics', path: paths.dashboard.general.analytics, icon: ICONS.analytics },
      { title: 'Vendors', path: paths.dashboard.vendors.root, icon: ICONS.product },
      { title: 'Audit', path: paths.dashboard.audit.root, icon: ICONS.file },
      { title: 'AI Auditor', path: paths.dashboard.chat, icon: ICONS.chat },
    ],
  },
  /**
   * Management
